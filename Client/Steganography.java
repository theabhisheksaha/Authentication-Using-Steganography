...
public class Steganography
{
     ...
     */
    public BufferedImage encode(String file,String message)
    {
    ...
    public String decode(BufferedImage image)
    {
        ...
        {
            System.out.println("Something went wrong in decoding");
            return "";
        }
    }
    ...
    private BufferedImage getImage(String f)
    {
        ...
        {
            System.out.println("Image could not be read!----Error in getImage----"+f);
        }
        return image;
    }
    ...
    private boolean setImage(BufferedImage image, File file, String ext)
    {
        ...
        {
            System.out.println("File could not be saved!----Error in setImage");
            return false;
        }
    }
    ...
    private BufferedImage add_text(BufferedImage image, String text)
    {
        ...
        {
            System.out.println("Target File cannot hold message!----Error in add_text");
        }
        return image;
    }
